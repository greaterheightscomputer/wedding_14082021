...
$(document).ready(function () {
  //nav toggle on hamburger button
...
// console.log(wHeight);
$(".gallery-popup .gp-img").css("max-height", wHeight + "px"); //resizing the image size
...
$(".gallery-item").click(function () {
  itemIndex = $(this).index(); //reassignment of itemIndex
  console.log("index: ", itemIndex); //click on each gallery image to see the index on the browser console.
  $(".gallery-popup").addClass("open");
  $(".gallery-popup .gp-img").hide();
  gpSlideShow(); //use or consume this gpSlideShow function
});
